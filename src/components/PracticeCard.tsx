      ...
      >
        ...
        <div className={cn(cardShellClasses, "rotate-y-180")}>
            ...
            {backTab === "tip" && (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="bg-slate-50 p-6 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden">
                  ...
                  <p className="text-base md:text-lg text-slate-800 font-medium italic leading-relaxed text-right">"{currentTip}"</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="p-8 pt-0 bg-white shrink-0 relative z-10">
            <div 
              className="w-full py-4 rounded-[2rem] border-2 font-black text-xs transition-all flex items-center justify-center gap-3 hover:bg-slate-50 group" 
