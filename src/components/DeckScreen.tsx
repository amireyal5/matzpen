...
export default function DeckScreen({ catKey, gender, onBack }: DeckScreenProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-background" style={{ backgroundColor: cat.light }}>
      {/* Navbar */}
      <div className="w-full max-w-lg px-6 pt-8 pb-4 flex items-center justify-between">
        <button 
          onClick={onBack} 
