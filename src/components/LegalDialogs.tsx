...
const CONTENT: Record<LegalType, { title: string; body: React.ReactNode }> = {
    ...
    body: (
      <div className="space-y-4 text-sm leading-relaxed text-slate-700">
        ...
        <ul className="list-disc pr-5 space-y-2">
          ...
          <li><strong>מחיקת חשבון:</strong> במידה ותרצה למחוק את חשבונך לצמיתות, כל המידע המקושר אליו יימחק מהשרתים באופן מיידי.</li>
        </ul>
      </div>
    ),
  },
  ...
  disclaimer: {
    ...
    body: (
      <div className="space-y-4 text-sm leading-relaxed text-slate-700">
        <p className="font-bold text-indigo-900 underline">כתב ויתור ואחריות (Disclaimer):</p>
        ...
        <p>יש לבצע את התרגילים הפיזיים בהתאם ליכולתך האישית. אם מורגש כאב, סחרחורת או אי-נוחות חריגה, יש להפסיק את הפעילות מיידית.</p>
