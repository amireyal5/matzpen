    ...
    body: (
      <div className="space-y-4 text-sm leading-relaxed text-slate-700">
        ...
        <ul className="list-disc pr-5 space-y-2">
          <li><strong>פרטיות מידע:</strong> כל המידע שאתה מזין נשמר באופן מקומי בלבד על גבי המכשיר שלך (בדפדפן) ואינו נשלח לשרת ענן חיצוני.</li>
          <li><strong>אבטחה:</strong> המידע שלך אינו נגיש לאף משתמש אחר או גורם חיצוני, מכיוון שהוא מאוחסן באופן מקומי בלבד במכשירך.</li>
          <li><strong>שליטה במידע:</strong> יש לך שליטה מלאה על המידע שלך. באפשרותך למחוק את כל נתוני האפליקציה וההתקדמות שלך בכל עת.</li>
        </ul>
      </div>
    ),
  },
